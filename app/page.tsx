...
export default async function Home() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#FDFDFD] overflow-x-hidden">
      ...
      {/* Hero Section */}
      <header 
        className="relative w-full text-center py-32 min-h-125 flex items-center justify-center animate-fade-in"
        style={{
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-8">
          ...
          {/* Clean, zen heading */}
          <h1 className="text-6xl md:text-8xl font-light text-[#1F2937] mb-6 tracking-tight animate-slide-down delay-150">
            人
          </h1>
          <h2 className="text-3xl md:text-4xl font-light text-[#1F2937] mb-8 tracking-wide animate-slide-down delay-300">
            REN
          </h2>
          
          {/* Minimal divider */}
          <div className="w-px h-12 bg-[#C084FC] mx-auto mb-8 animate-zoom-in delay-500"></div>
          
          {/* Clean subtitle */}
          <p className="text-lg md:text-xl text-[#4B5563] mb-12 font-light leading-relaxed max-w-xl mx-auto animate-slide-up delay-700">
            Natural soap, thoughtfully crafted
          </p>
          
          {/* Minimal CTA */}
          <a href="/shop/all-soaps" className="inline-block text-sm text-[#1F2937] font-medium tracking-wider uppercase border-b-2 border-[#C084FC] pb-1 hover:text-[#C084FC] transition-colors duration-300 animate-slide-up delay-1000">
            Explore
          </a>
        </div>
      </header>
      ...
      <main className="w-full flex-1">
        ...
        <section className="w-full px-8 py-16 bg-linear-to-br from-[#1F2937] via-[#2D1B4E] to-[#1F2937] relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            </ScrollReveal>            <WinterCollectionCarousel products={winterProducts} />
          </div>
        </section>
        {/* Newsletter Section */}
